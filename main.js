...
global.channelLink = "https://whatsapp.com/channel/0029Vb6kUic4tRrmkLhtL042";
global.ytch = "Mr Phantom Hacker";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb6kUic4tRrmkLhtL042' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/Frkh4xvpL0X9LJx4tHEWKk?mode=wwt` 
                }, { quoted: message });
                return;
            }
        }
